    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-x-5 mt-10">
          <span className="flex justify-center items-center text-3xl bg-linear-to-b from-rose-400 to-rose-500 text-white w-15 h-15 rounded-full">
            {item.icon}
          </span>
...
const steps = [
  {
    ...
    title: "Sourcing",
    para: "We source quality materials.",
    icon: <PiPlant />,
  },

  {
    ...
    title: "Manufacturing",
    para: "We manufacture with precision.",
    icon: <PiFactory />,
  },

  {
    ...
    para: "We ensure product excellence.",
    icon: <SlBadge />,
  },

  {
    ...
    title: "Logistics",
    para: "We deliver safely and on time.",
    icon: <BsTruck />,
  },
];
